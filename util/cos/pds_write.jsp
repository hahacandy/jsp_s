...
<!--     다음에 추가할 로그인  -->
   ...
   <td width="80%" valign="top">&nbsp;<br>
	...
	<form name="frm" method="post" action="pds_write" enctype="multipart/form-data">
	  <table border="0" >
		<tr>
       ...
       <tr>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			<a href="javascript:write()"><img src="Pds/img/purple_save.gif" width="56" height="18" border="0"></a>
