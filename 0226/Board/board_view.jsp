     ...
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com"><%=rs.getString("name")%></a> / <font size="2" face="돋움"><%=rs.getString("regdate")%> / <%=rs.getString("readcnt")%>번 읽음</font>
             <p>
      ...
      <font size="2">
       ...
       <img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="board_delete.jsp?idx=<%=rs.getInt("idx")%>"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
