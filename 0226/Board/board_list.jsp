				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>15</b>건 - 1/ 2 Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="center" height="25"><font face="돋움" size="2"
							color="#000000"><%=rs.getInt("idx") %></font></td>
						<td align="left" height="20">&nbsp; <font face="돋움" size="2"
							color="#000000"> <a class="list" href=""><a href="board_view.jsp?idx=<%=rs.getInt("idx")%>"><%=rs.getString("subject") %></a></td>
						<td align="center" height="20"><font face="돋움" size="2">
								<a class="list" href="mailto:ein1027@nate.com"><%=rs.getString("name") %></a>
						</font></td>
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="left" height="20">&nbsp; <font face="돋움" size="2"
							color="#000000"> <a class="list" href="">등록된 글이 없습니다.</a></td>
						<td align="center" height="20"><font face="돋움" size="2">
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="left" height="20">&nbsp; <img
							src="./img/reply2.gif"> <font face="돋움" size="2"
							color="#000000"> <a class="list" href="">제목부분입니다</a></td>
						<td align="center" height="20"><font face="돋움" size="2">
					...
					<div align="center">
						...
						<table width="600">
							<tr>
								...
								<a href="javascript:moveWrite()"><img src="./img/write.gif" border="0"></a></td>
							</tr>
						</table>
</body>
</html>
