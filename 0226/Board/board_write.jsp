...
<html>
   <head><title>게시판 작성</title>
	...
	<script type="text/javascript">
		function insert() {
			frm.action="board_write_pro.jsp";
			frm.submit();
		}
	</script>
	  ...
	  <table border="0">
	   ...
	   <tr>
		...
		<tr>
          ...
          <td>
                     <a href="javascript:insert()"><img src="./img/save.gif" border=0></a>&nbsp;&nbsp;&nbsp;
                     <a href="javascript:history.go(-1)"><img src="./img/cancle.gif" border=0></a>
          </td>
        </tr>
      </table>
      </form>
