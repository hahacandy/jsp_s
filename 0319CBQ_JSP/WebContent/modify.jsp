...
<%
	...
	if(request.getParameter("custno")!=null && 
		...
		boolean result = modifySales(custno, saleno, pcost, amount, price, pcode, sdate);
	...
	<section>
		...
		<form action="" name="frm" method="post" onsubmit="return false">
			<table>
				...
				<tr>
					<th>회원번호</th>
					<td><input type="text" name="custno" value="<%=vo.get(0)%>"
						readonly>수정불가</td>
				</tr>

				<tr>
					<th>판매번호</th>
					<td><input type="text" name="saleno" value="<%=vo.get(1)%>"
						readonly>수정불가</td>
				</tr>

				<tr>
					<th>단가</th>
					<td><input type="text" name="pcost" value="<%=vo.get(2)%>"></td>
				</tr>

				<tr>
					<th>수량</th>
					<td><input type="text" name="amount" value="<%=vo.get(3)%>"></td>
				</tr>

				<tr>
					<th>가격</th>
					<td><input type="text" name="price" value="<%=vo.get(4)%>"></td>
				</tr>

				<tr>
					<th>상품코드</th>
					<td><input type="text" name="pcode" value="<%=vo.get(5)%>"></td>
				</tr>

				<tr>
					<th>판매일자</th>
					<td><input type="text" name="sdate" value="<%=vo.get(6)%>">예)20101010</td>
				</tr>
