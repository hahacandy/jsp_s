...
<script type="text/javascript">
	function id_check() {
		window.open("id_check", "아이디 중복 확인", "width=340 height=240");
	}
	
	function insert() {
		form_name.action="userinfo_insert";
		form_name.submit();
	}
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  			<a href="javascript:id_check()"><img src="Member/img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <a href="javascript:insert()"><img src="Member/img/u_bt06.gif" vspace=3 border=0 name=img3></a>
