...
<%
	...
	List<GuestVO> guestVOs = dao.getAllPost();
%>
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : <b><%=guestVOs.size() %></b>건 - 1/ 2 Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
...
<%
		...
		int cnt = guestVOs.size();
		for(GuestVO vo : guestVOs) {
%>
			<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
				...
				<td align="left" height="20">&nbsp;
					<font face="돋움" size="2" color="#000000"><a class="list" href="board_view.jsp?idx=<%=vo.getIdx()%>"><%=vo.getSubject() %></a></font>
				</td>
				
				<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com"><%=vo.getName() %></a></font>
				</td>
				
				<td align="center" height="20">
					<font face="돋움" size="2"><%=vo.getRegdate().substring(0,10) %></font>
				</td>
				<td align="center" height="20">
					<font face="돋움" size="2"><%=vo.getReadcnt() %></font>
				</td>
